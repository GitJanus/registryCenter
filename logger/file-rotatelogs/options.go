...
import (
	option2 "registryCenter/logger/file-rotatelogs/internal/option"
	"time"
)
...
func WithClock(c Clock) Option {
	return option2.New(optkeyClock, c)
}
...
func WithLocation(loc *time.Location) Option {
	return option2.New(optkeyClock, clockFn(func() time.Time {
...
func WithLinkName(s string) Option {
	return option2.New(optkeyLinkName, s)
}
...
func WithMaxAge(d time.Duration) Option {
	return option2.New(optkeyMaxAge, d)
}

// WithRotationTime creates a new Option that sets the
// time between rotation.
func WithRotationTime(d time.Duration) Option {
	return option2.New(optkeyRotationTime, d)
}
...
func WithRotationCount(n uint) Option {
	return option2.New(optkeyRotationCount, n)
}
...
func WithHandler(h Handler) Option {
	return option2.New(optkeyHandler, h)
}
...
func ForceNewFile() Option {
	return option2.New(optkeyForceNewFile, true)
}

func WithRotationSize(i int) Option {
	return option2.New(optkeyRotationSize, i)
}
